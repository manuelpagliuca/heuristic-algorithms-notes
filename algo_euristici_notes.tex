...
ci sono dei casi critici, come il seguente zaino con un volume $V=10$.
\begin{center}
    \begin{tabular}{c|c c}
        B           & a  & b  \\
        \midrule
...
è dato dal primo oggetto scartato ha si una grande volume ma anche un grande valore.
...
L'euristica NN (Nearest Neighbour) adotta la funzione oggettiva come criterio di selezione:
\begin{itemize}
...
\end{itemize}
Molto criteri $\varphi_A (i,x)$ ammettono equivalenti forme dipendendo solamente da $i$:
\begin{itemize}
    \item nel KP, $\varphi_A(i,x)$
\end{itemize}
