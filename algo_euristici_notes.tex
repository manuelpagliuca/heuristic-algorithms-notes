...
inserire immagini
\subsection{Complessità nel caso medio (avarage-case complexity)}
Alcuni algoritmi sono inefficenti solo in un insieme di istanze ridotte, per esempio
...
\begin{itemize}
    ...
    aggiungo oguno alla CNF con probabilità $p$.
    \item \textbf{Insieme con dimensione fissa}: costuisco $m$ formule,
...
Questo è utile per predirre il comportamento di un algoritmo data un istanza.
...
\begin{itemize}
    ...
    può essere efficiente in un caso specifico, ed inefficente in un caso peggiore.
